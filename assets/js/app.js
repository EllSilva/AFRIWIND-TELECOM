...
import page_vender from './view/solicitacao/vender.js'
Vue.component('p-vender', page_vender)

import page_compra from './view/solicitacao/compra.js'
Vue.component('p-compra', page_compra)
...
const routes = [
    ...
    { path: '/vender/imovel', component: { template: '<p-vender></p-vender>' } },
    { path: '/compra/imovel', component: { template: '<p-compra></p-compra>' } },
